...
public class FrescoBasedReactTextInlineImageSpan extends TextInlineImageSpan {
    ...
    public void draw(Canvas canvas, CharSequence charSequence, int i, int i2, float f, int i3, int i4, int i5, Paint paint) {
        if (this.mDrawable == null) {
            ...
            this.mDraweeHolder.setController(this.mDraweeControllerBuilder.reset().mo113setOldController(this.mDraweeHolder.getController()).mo112setCallerContext(this.mCallerContext).setImageRequest(fromBuilderWithHeaders).mo111build());
