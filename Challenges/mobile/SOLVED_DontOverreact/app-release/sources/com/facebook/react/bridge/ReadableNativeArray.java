        ...
        for (int i = 0; i < size(); i++) {
            switch (AnonymousClass1.$SwitchMap$com$facebook$react$bridge$ReadableType[getType(i).ordinal()]) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    arrayList.add(mo175getMap(i).toHashMap());
                    break;
                case 6:
                    arrayList.add(mo174getArray(i).toArrayList());
                    break;
                default:
