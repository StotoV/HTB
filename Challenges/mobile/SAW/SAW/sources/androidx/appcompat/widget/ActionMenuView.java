...
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
    ...
    private void onMeasureExactFormat(int i, int i2) {
        ...
        if (i14 <= 0 || j == 0 || (i14 >= i17 - 1 && !z7 && i18 <= 1)) {
            ...
            int i36 = bitCount > 0.0f ? (int) ((i14 * i13) / bitCount) : 0;
    ...
    public LayoutParams mo24generateDefaultLayoutParams() {
    ...
    public LayoutParams mo25generateLayoutParams(AttributeSet attributeSet) {
    ...
    @Override // androidx.appcompat.widget.LinearLayoutCompat, android.view.ViewGroup
    /* renamed from: generateLayoutParams  reason: collision with other method in class */
    public LayoutParams mo26generateLayoutParams(ViewGroup.LayoutParams layoutParams) {
        ...
        return mo24generateDefaultLayoutParams();
    }
    ...
    public LayoutParams generateOverflowButtonLayoutParams() {
        LayoutParams mo24generateDefaultLayoutParams = mo24generateDefaultLayoutParams();
        mo24generateDefaultLayoutParams.isOverflowButton = true;
        return mo24generateDefaultLayoutParams;
    }
