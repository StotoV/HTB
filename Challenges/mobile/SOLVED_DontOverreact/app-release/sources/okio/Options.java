    ...
    */
    ...
    private static void buildTrieRecursive(long j, Buffer buffer, int i, List<ByteString> list, int i2, int i3, List<Integer> list2) {
        ...
        if (byteString.getByte(i) != byteString2.getByte(i)) {
            ...
            while (i14 < i3) {
                ...
                if (i15 == i5 && i + 1 == list.get(i14).size()) {
                    buffer.mo224writeInt(list2.get(i14).intValue());
                    i6 = i5;
                    buffer2 = buffer3;
                } else {
                    buffer.mo224writeInt((int) ((intCount(buffer3) + intCount) * (-1)));
                    i6 = i5;
                    buffer2 = buffer3;
        ...
        while (true) {
            ...
            buffer.mo224writeInt(byteString.getByte(i19) & 255);
            i19++;
        }
        if (i10 + 1 == i3) {
            ...
            buffer.mo224writeInt(list2.get(i10).intValue());
            return;
        }
        Buffer buffer5 = new Buffer();
        buffer.mo224writeInt((int) ((intCount(buffer5) + intCount2) * (-1)));
