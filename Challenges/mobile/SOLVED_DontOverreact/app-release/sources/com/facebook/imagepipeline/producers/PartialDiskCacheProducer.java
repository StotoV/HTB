...
public class PartialDiskCacheProducer implements Producer<EncodedImage> {
    ...
    private Continuation<EncodedImage, Void> onFinishDiskReads(final Consumer<EncodedImage> consumer, final ProducerContext producerContext, final CacheKey cacheKey) {
        ...
        return new Continuation<EncodedImage, Void>() { // from class: com.facebook.imagepipeline.producers.PartialDiskCacheProducer.1
            ...
            public Void mo154then(Task<EncodedImage> task) throws Exception {
    ...
    public static class PartialDiskCacheConsumer extends DelegatingConsumer<EncodedImage, EncodedImage> {
        ...
        private PooledByteBufferOutputStream merge(EncodedImage encodedImage, EncodedImage encodedImage2) throws IOException {
            PooledByteBufferOutputStream mo144newOutputStream = this.mPooledByteBufferFactory.mo144newOutputStream(encodedImage2.getSize() + encodedImage2.getBytesRange().from);
            copy(encodedImage.getInputStream(), mo144newOutputStream, encodedImage2.getBytesRange().from);
            copy(encodedImage2.getInputStream(), mo144newOutputStream, encodedImage2.getSize());
            return mo144newOutputStream;
        }
