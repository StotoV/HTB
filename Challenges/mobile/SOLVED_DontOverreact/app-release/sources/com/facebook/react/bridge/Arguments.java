        ...
        for (int i = 0; i < readableArray.size(); i++) {
            switch (AnonymousClass2.$SwitchMap$com$facebook$react$bridge$ReadableType[readableArray.getType(i).ordinal()]) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    arrayList.add(toBundle(readableArray.mo175getMap(i)));
                    break;
                case 6:
                    arrayList.add(toList(readableArray.mo174getArray(i)));
                    break;
                default:
        ...
        while (keySetIterator.hasNextKey()) {
            ...
            switch (AnonymousClass2.$SwitchMap$com$facebook$react$bridge$ReadableType[readableMap.getType(nextKey).ordinal()]) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    bundle.putBundle(nextKey, toBundle(readableMap.mo176getMap(nextKey)));
                    break;
                case 6:
