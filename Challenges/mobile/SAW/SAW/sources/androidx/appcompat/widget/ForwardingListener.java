...
public abstract class ForwardingListener implements View.OnTouchListener, View.OnAttachStateChangeListener {
    ...
    public abstract ShowableListMenu mo28getPopup();
    ...
    protected boolean onForwardingStarted() {
        ShowableListMenu mo28getPopup = mo28getPopup();
        if (mo28getPopup == null || mo28getPopup.isShowing()) {
            return true;
        }
        mo28getPopup.show();
        return true;
    ...
    */
    ...
    private boolean onTouchForwarded(MotionEvent motionEvent) {
        ...
        View view = this.mSrc;
        ShowableListMenu mo28getPopup = mo28getPopup();
        if (mo28getPopup == null || !mo28getPopup.isShowing() || (dropDownListView = (DropDownListView) mo28getPopup.getListView()) == null || !dropDownListView.isShown()) {
            return false;
        }
