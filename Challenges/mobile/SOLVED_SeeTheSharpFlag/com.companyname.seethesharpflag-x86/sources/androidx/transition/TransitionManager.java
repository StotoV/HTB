...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        if (!sPendingTransitions.contains(sceneRoot)) {
            ...
            Transition m122clone = transition.m122clone();
            m122clone.mo136setSceneRoot(sceneRoot);
            if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
                m122clone.setCanRemoveViews(true);
            }
            sceneChangeSetup(sceneRoot, m122clone);
            scene.enter();
            sceneChangeRunTransition(sceneRoot, m122clone);
        }
    }
    ...
    public static class MultiListener implements ViewTreeObserver.OnPreDrawListener, View.OnAttachStateChangeListener {
        ...
        public boolean onPreDraw() {
            ...
            this.mTransition.mo123addListener(new TransitionListenerAdapter() { // from class: androidx.transition.TransitionManager.MultiListener.1
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition m122clone = transition.m122clone();
        sceneChangeSetup(viewGroup, m122clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, m122clone);
    }
