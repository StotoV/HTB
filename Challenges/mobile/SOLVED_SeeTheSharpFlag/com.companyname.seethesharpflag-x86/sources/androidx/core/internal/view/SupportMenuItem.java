...
public interface SupportMenuItem extends MenuItem {
    ...
    MenuItem mo34setActionView(int i);

    @Override // android.view.MenuItem
    /* renamed from: setActionView */
    MenuItem mo35setActionView(View view);
    ...
    SupportMenuItem mo36setContentDescription(CharSequence charSequence);
    ...
    MenuItem mo37setShowAsActionFlags(int i);

    SupportMenuItem setSupportActionProvider(ActionProvider actionProvider);

    @Override // android.view.MenuItem
    /* renamed from: setTooltipText */
    SupportMenuItem mo38setTooltipText(CharSequence charSequence);
}
