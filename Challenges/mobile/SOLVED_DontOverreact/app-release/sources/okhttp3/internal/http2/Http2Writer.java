...
final class Http2Writer implements Closeable {
    ...
    public synchronized void connectionPreface() throws IOException {
        ...
        this.sink.mo219write(Http2.CONNECTION_PREFACE.toByteArray());
        this.sink.flush();
    }
    ...
    public synchronized void pushPromise(int i, int i2, List<Header> list) throws IOException {
        ...
        this.sink.mo224writeInt(i2 & Integer.MAX_VALUE);
    ...
    public synchronized void rstStream(int i, ErrorCode errorCode) throws IOException {
        ...
        this.sink.mo224writeInt(errorCode.httpCode);
        this.sink.flush();
    }
    ...
    public synchronized void settings(Settings settings) throws IOException {
        ...
        while (i < 10) {
            if (settings.isSet(i)) {
                this.sink.mo228writeShort(i == 4 ? 3 : i == 7 ? 4 : i);
                this.sink.mo224writeInt(settings.get(i));
            }
            i++;
        }
        this.sink.flush();
    ...
    public synchronized void ping(boolean z, int i, int i2) throws IOException {
        ...
        this.sink.mo224writeInt(i);
        this.sink.mo224writeInt(i2);
        this.sink.flush();
    }
    ...
    public void frameHeader(int i, int i2, byte b, byte b2) throws IOException {
        ...
        if (i2 <= i3) {
            ...
            this.sink.mo221writeByte(b & 255);
            this.sink.mo221writeByte(b2 & 255);
            this.sink.mo224writeInt(i & Integer.MAX_VALUE);
            return;
        }
    ...
    private static void writeMedium(BufferedSink bufferedSink, int i) throws IOException {
        bufferedSink.mo221writeByte((i >>> 16) & 255);
        bufferedSink.mo221writeByte((i >>> 8) & 255);
        bufferedSink.mo221writeByte(i & 255);
    }
