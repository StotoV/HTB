...
public abstract class AbstractDraweeController<T, INFO> implements DraweeController, DeferredReleaser.Releasable, GestureDetector.ClickListener {
    ...
    protected T mo106getCachedImage() {
        return null;
    }
    ...
    protected void submitRequest() {
        ...
        T mo106getCachedImage = mo106getCachedImage();
        if (mo106getCachedImage != null) {
            if (FrescoSystrace.isTracing()) {
            ...
            onImageLoadedFromCacheImmediately(this.mId, mo106getCachedImage);
            onNewResultInternal(this.mId, this.mDataSource, mo106getCachedImage, 1.0f, true, true, true);
            if (FrescoSystrace.isTracing()) {
                FrescoSystrace.endSection();
            }
            if (!FrescoSystrace.isTracing()) {
        ...
        this.mDataSource.subscribe(new BaseDataSubscriber<T>() { // from class: com.facebook.drawee.controller.AbstractDraweeController.1
            ...
            public void onNewResultImpl(DataSource<T> dataSource) {
                ...
                T mo129getResult = dataSource.mo129getResult();
                if (mo129getResult != null) {
                    AbstractDraweeController.this.onNewResultInternal(str, dataSource, mo129getResult, progress, isFinished, hasResult, hasMultipleResults);
                } else if (!isFinished) {
                } else {
