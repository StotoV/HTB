...
public class ResizeAndRotateProducer implements Producer<EncodedImage> {
    ...
    private class TransformingConsumer extends DelegatingConsumer<EncodedImage, EncodedImage> {
        ...
        public void doTransform(EncodedImage encodedImage, int i, ImageTranscoder imageTranscoder) {
            ...
            PooledByteBufferOutputStream mo143newOutputStream = ResizeAndRotateProducer.this.mPooledByteBufferFactory.mo143newOutputStream();
            try {
                ImageTranscodeResult transcode = imageTranscoder.transcode(encodedImage, mo143newOutputStream, imageRequest.getRotationOptions(), imageRequest.getResizeOptions(), null, 85);
                ...
                CloseableReference of = CloseableReference.of(mo143newOutputStream.mo145toByteBuffer());
                try {
