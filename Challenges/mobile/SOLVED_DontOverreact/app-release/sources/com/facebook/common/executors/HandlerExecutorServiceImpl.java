...
public class HandlerExecutorServiceImpl extends AbstractExecutorService implements HandlerExecutorService {
    ...
    protected /* bridge */ /* synthetic */ RunnableFuture mo94newTaskFor(Runnable runnable, @Nullable Object obj) {
    ...
    public /* bridge */ /* synthetic */ Future submit(Runnable runnable, @Nullable Object obj) {
        return mo97submit(runnable, (Runnable) obj);
    }
    ...
    public <T> ScheduledFutureImpl<T> mo95newTaskFor(Callable<T> callable) {
        return new ScheduledFutureImpl<>(this.mHandler, callable);
    }

    @Override // java.util.concurrent.AbstractExecutorService, java.util.concurrent.ExecutorService
    public ScheduledFuture<?> submit(Runnable runnable) {
        return mo97submit(runnable, (Runnable) null);
    }

    @Override // java.util.concurrent.AbstractExecutorService, java.util.concurrent.ExecutorService
    /* renamed from: submit  reason: collision with other method in class */
    public <T> ScheduledFuture<T> mo97submit(Runnable runnable, @Nullable T t) {
    ...
    public <T> ScheduledFuture<T> submit(Callable<T> callable) {
        ...
        ScheduledFutureImpl<T> mo95newTaskFor = mo95newTaskFor((Callable) callable);
        execute(mo95newTaskFor);
        return mo95newTaskFor;
    }
    ...
    public <V> ScheduledFuture<V> schedule(Callable<V> callable, long j, TimeUnit timeUnit) {
        ScheduledFutureImpl mo95newTaskFor = mo95newTaskFor((Callable) callable);
        this.mHandler.postDelayed(mo95newTaskFor, timeUnit.toMillis(j));
        return mo95newTaskFor;
    }
