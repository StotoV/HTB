...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    ...
    */
    ...
    public CoordinatorLayout.Behavior<AppBarLayout> mo162getBehavior() {
        return new Behavior();
    }
    ...
    public LayoutParams mo146generateDefaultLayoutParams() {
        return new LayoutParams(-1, -2);
    }

    @Override // android.widget.LinearLayout, android.view.ViewGroup
    /* renamed from: generateLayoutParams  reason: collision with other method in class */
    public LayoutParams mo148generateLayoutParams(AttributeSet attributeSet) {
    ...
    @Override // android.widget.LinearLayout, android.view.ViewGroup
    /* renamed from: generateLayoutParams  reason: collision with other method in class */
    public LayoutParams mo149generateLayoutParams(ViewGroup.LayoutParams layoutParams) {
    ...
    public static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        public static class SavedState extends AbsSavedState {
            public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: com.google.android.material.appbar.AppBarLayout.BaseBehavior.SavedState.1
                ...
                public SavedState mo153createFromParcel(Parcel parcel, ClassLoader classLoader) {
                    return new SavedState(parcel, classLoader);
                }

                @Override // android.os.Parcelable.Creator
                /* renamed from: createFromParcel */
                public SavedState mo152createFromParcel(Parcel parcel) {
                    return new SavedState(parcel, null);
                }

                @Override // android.os.Parcelable.Creator
                /* renamed from: newArray */
                public SavedState[] mo154newArray(int i) {
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        /* bridge */ /* synthetic */ View mo155findFirstDependency(List list) {
            return mo155findFirstDependency((List<View>) list);
        }
        ...
        public boolean onRequestChildRectangleOnScreen(CoordinatorLayout coordinatorLayout, View view, Rect rect, boolean z) {
            AppBarLayout mo155findFirstDependency = mo155findFirstDependency(coordinatorLayout.getDependencies(view));
            if (mo155findFirstDependency != null) {
                rect.offset(view.getLeft(), view.getTop());
                Rect rect2 = this.tempRect1;
                rect2.set(0, 0, coordinatorLayout.getWidth(), coordinatorLayout.getHeight());
                if (!rect2.contains(rect)) {
                    mo155findFirstDependency.setExpanded(false, !z);
                    return true;
                }
            }
            return false;
        ...
        AppBarLayout mo155findFirstDependency(List<View> list) {
            int size = list.size();
            for (int i = 0; i < size; i++) {
