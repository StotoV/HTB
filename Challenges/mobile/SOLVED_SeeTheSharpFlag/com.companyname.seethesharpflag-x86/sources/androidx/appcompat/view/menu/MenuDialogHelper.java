...
class MenuDialogHelper implements DialogInterface.OnKeyListener, DialogInterface.OnClickListener, DialogInterface.OnDismissListener, MenuPresenter.Callback {
    ...
    public void show(IBinder iBinder) {
        ...
        builder.mo197setAdapter(this.mPresenter.getAdapter(), this);
        View headerView = menuBuilder.getHeaderView();
        if (headerView != null) {
            builder.mo200setCustomTitle(headerView);
        } else {
            builder.mo202setIcon(menuBuilder.getHeaderIcon()).mo229setTitle(menuBuilder.getHeaderTitle());
        }
        builder.mo220setOnKeyListener(this);
