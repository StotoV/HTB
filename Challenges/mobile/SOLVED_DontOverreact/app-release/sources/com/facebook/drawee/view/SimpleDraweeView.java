...
public class SimpleDraweeView extends GenericDraweeView {
    ...
    private void init(Context context, @Nullable AttributeSet attributeSet) {
        ...
        try {
            ...
            if (isInEditMode()) {
                ...
                this.mControllerBuilder = sDraweecontrollerbuildersupplier.mo126get();
            }
    ...
    public void setImageRequest(ImageRequest imageRequest) {
        setController(this.mControllerBuilder.setImageRequest(imageRequest).mo113setOldController(getController()).mo111build());
    }
    ...
    public void setImageURI(Uri uri, @Nullable Object obj) {
        setController(this.mControllerBuilder.mo112setCallerContext(obj).mo108setUri(uri).mo113setOldController(getController()).mo111build());
    }
