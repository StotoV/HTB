...
public final class Http1Codec implements HttpCodec {
    ...
    public void writeRequest(Headers headers, String str) throws IOException {
        ...
        this.sink.mo232writeUtf8(str).mo232writeUtf8("\r\n");
        int size = headers.size();
        for (int i = 0; i < size; i++) {
            this.sink.mo232writeUtf8(headers.name(i)).mo232writeUtf8(": ").mo232writeUtf8(headers.value(i)).mo232writeUtf8("\r\n");
        }
        this.sink.mo232writeUtf8("\r\n");
        this.state = 1;
    }
    ...
    public final class ChunkedSink implements Sink {
        ...
        public void write(Buffer buffer, long j) throws IOException {
            if (!this.closed) {
                ...
                Http1Codec.this.sink.mo223writeHexadecimalUnsignedLong(j);
                Http1Codec.this.sink.mo232writeUtf8("\r\n");
                Http1Codec.this.sink.write(buffer, j);
                Http1Codec.this.sink.mo232writeUtf8("\r\n");
                return;
            }
        ...
        public synchronized void close() throws IOException {
            ...
            this.closed = true;
            Http1Codec.this.sink.mo232writeUtf8("0\r\n\r\n");
            Http1Codec.this.detachTimeout(this.timeout);
            Http1Codec.this.state = 3;
        }
    }
