...
public class PipelineDraweeControllerBuilder extends AbstractDraweeControllerBuilder<PipelineDraweeControllerBuilder, ImageRequest, CloseableReference<CloseableImage>, ImageInfo> {
    ...
    /* renamed from: setUri */
    public PipelineDraweeControllerBuilder mo108setUri(@Nullable Uri uri) {
        if (uri == null) {
    ...
    @Override // com.facebook.drawee.interfaces.SimpleDraweeControllerBuilder
    /* renamed from: setUri */
    public PipelineDraweeControllerBuilder mo109setUri(@Nullable String str) {
        if (str == null || str.isEmpty()) {
            return (PipelineDraweeControllerBuilder) super.setImageRequest(ImageRequest.fromUri(str));
        }
        return mo108setUri(Uri.parse(str));
    }
    ...
    public PipelineDraweeController mo107obtainController() {
