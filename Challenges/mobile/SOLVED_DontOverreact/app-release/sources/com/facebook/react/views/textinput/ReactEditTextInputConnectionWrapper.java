...
class ReactEditTextInputConnectionWrapper extends InputConnectionWrapper {
    ...
    public ReactEditTextInputConnectionWrapper(InputConnection inputConnection, ReactContext reactContext, ReactEditText reactEditText) {
        ...
        this.mKey = null;
        this.mEventDispatcher = ((UIManagerModule) Assertions.assertNotNull(reactContext.getNativeModule(UIManagerModule.class))).mo180getEventDispatcher();
    ...
    public boolean setComposingText(CharSequence charSequence, int i) {
        ...
        dispatchKeyEventOrEnqueue((z || (!z2 && z3)) ? BACKSPACE_KEY_VALUE : String.valueOf(this.mEditText.mo27getText().charAt(selectionStart2 - 1)));
