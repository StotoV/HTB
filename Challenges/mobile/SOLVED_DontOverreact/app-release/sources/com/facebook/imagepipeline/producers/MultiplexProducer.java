...
public abstract class MultiplexProducer<K, T extends Closeable> implements Producer<T> {
    ...
    /* renamed from: getKey */
    protected abstract K mo149getKey(ProducerContext producerContext);
    ...
    public void produceResults(Consumer<T> consumer, ProducerContext producerContext) {
        ...
        try {
            ...
            K mo149getKey = mo149getKey(producerContext);
            do {
                z = false;
                synchronized (this) {
                    existingMultiplexer = getExistingMultiplexer(mo149getKey);
                    if (existingMultiplexer == null) {
                        existingMultiplexer = createAndPutNewMultiplexer(mo149getKey);
                        z = true;
                    }
                }
