    ...
    */
    ...
    public static class SavedState extends View.BaseSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() { // from class: androidx.appcompat.widget.AppCompatSpinner.SavedState.1
            ...
            public SavedState mo47createFromParcel(Parcel parcel) {
            ...
            public SavedState[] mo48newArray(int i) {
    ...
    class DialogPopup implements SpinnerPopup, DialogInterface.OnClickListener {
        ...
        public void show(int i, int i2) {
            ...
            if (charSequence != null) {
                builder.mo229setTitle(charSequence);
            }
            AlertDialog create = builder.mo226setSingleChoiceItems(this.mListAdapter, AppCompatSpinner.this.getSelectedItemPosition(), this).create();
            this.mPopup = create;
