...
public final class MaterialCalendarGridView extends GridView {
    ...
    protected final void onDraw(Canvas canvas) {
        ...
        Long mo189getItem = adapter2.mo189getItem(adapter2.firstPositionInMonth());
        Long mo189getItem2 = adapter2.mo189getItem(adapter2.lastPositionInMonth());
        for (Pair<Long, Long> pair : dateSelector.getSelectedRanges()) {
            if (pair.first != null) {
                if (pair.second == null) {
                    ...
                    if (skipMonth(mo189getItem, mo189getItem2, Long.valueOf(longValue), Long.valueOf(longValue2))) {
                        return;
                    }
                    if (longValue < mo189getItem.longValue()) {
                    ...
                    if (longValue2 > mo189getItem2.longValue()) {
