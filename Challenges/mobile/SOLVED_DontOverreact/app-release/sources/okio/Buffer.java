...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public Buffer mo217emitCompleteSegments() {
        return this;
    }
    ...
    public OutputStream outputStream() {
        return new OutputStream() { // from class: okio.Buffer.1
            ...
            public void write(int i) {
                Buffer.this.mo221writeByte((int) ((byte) i));
            }

            @Override // java.io.OutputStream
            public void write(byte[] bArr, int i, int i2) {
                Buffer.this.mo220write(bArr, i, i2);
            }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:18:0x003d, code lost:
        r1 = new okio.Buffer().mo222writeDecimalLong(r3).mo221writeByte((int) r15);
     */
    ...
    */
    public long readDecimalLong() {
        ...
        L3d:
            ...
            r1.<init>()
            okio.Buffer r1 = r1.mo222writeDecimalLong(r3)
            okio.Buffer r1 = r1.mo221writeByte(r15)
            if (r8 != 0) goto L4f
            r1.readByte()
        L4f:
    ...
    */
    public long readHexadecimalUnsignedLong() {
        ...
        L4a:
            ...
            r0.<init>()
            okio.Buffer r0 = r0.mo223writeHexadecimalUnsignedLong(r4)
            okio.Buffer r0 = r0.mo221writeByte(r10)
            java.lang.NumberFormatException r1 = new java.lang.NumberFormatException
            java.lang.StringBuilder r2 = new java.lang.StringBuilder
            r2.<init>()
    ...
    */
    ...
    @Override // okio.BufferedSink
    /* renamed from: write */
    public Buffer mo218write(ByteString byteString) {
        if (byteString == null) {
    ...
    public Buffer mo232writeUtf8(String str) {
        return mo233writeUtf8(str, 0, str.length());
    }

    @Override // okio.BufferedSink
    /* renamed from: writeUtf8 */
    public Buffer mo233writeUtf8(String str, int i, int i2) {
        if (str != null) {
            if (i < 0) {
                ...
                while (i < i2) {
                    ...
                    if (charAt < 128) {
                        ...
                        if (charAt < 2048) {
                            mo221writeByte((charAt >> 6) | JfifUtil.MARKER_SOFn);
                            mo221writeByte((charAt & '?') | 128);
                        } else if (charAt < 55296 || charAt > 57343) {
                            mo221writeByte((charAt >> '\f') | 224);
                            mo221writeByte(((charAt >> 6) & 63) | 128);
                            mo221writeByte((charAt & '?') | 128);
                        } else {
                            int i6 = i + 1;
                            ...
                            if (charAt > 56319 || charAt3 < 56320 || charAt3 > 57343) {
                                ...
                                mo221writeByte((i7 >> 18) | 240);
                                mo221writeByte(((i7 >> 12) & 63) | 128);
                                mo221writeByte(((i7 >> 6) & 63) | 128);
                                mo221writeByte((i7 & 63) | 128);
                                i += 2;
                            }
                        }
                        i++;
    ...
    public Buffer mo234writeUtf8CodePoint(int i) {
        if (i < 128) {
            mo221writeByte(i);
        } else if (i < 2048) {
            mo221writeByte((i >> 6) | JfifUtil.MARKER_SOFn);
            mo221writeByte((i & 63) | 128);
        } else if (i < 65536) {
            if (i >= 55296 && i <= 57343) {
                mo221writeByte(63);
            } else {
                mo221writeByte((i >> 12) | 224);
                mo221writeByte(((i >> 6) & 63) | 128);
                mo221writeByte((i & 63) | 128);
            }
        } else if (i <= 1114111) {
            mo221writeByte((i >> 18) | 240);
            mo221writeByte(((i >> 12) & 63) | 128);
            mo221writeByte(((i >> 6) & 63) | 128);
            mo221writeByte((i & 63) | 128);
        } else {
    ...
    public Buffer mo231writeString(String str, Charset charset) {
        return mo230writeString(str, 0, str.length(), charset);
    }

    @Override // okio.BufferedSink
    /* renamed from: writeString */
    public Buffer mo230writeString(String str, int i, int i2, Charset charset) {
        if (str != null) {
            if (i < 0) {
                ...
                if (charset.equals(Util.UTF_8)) {
                    return mo233writeUtf8(str, i, i2);
                }
                byte[] bytes = str.substring(i, i2).getBytes(charset);
                return mo220write(bytes, 0, bytes.length);
            } else {
                throw new IllegalArgumentException("endIndex > string.length: " + i2 + " > " + str.length());
            }
        }
    ...
    @Override // okio.BufferedSink
    /* renamed from: write */
    public Buffer mo219write(byte[] bArr) {
        if (bArr == null) {
            throw new IllegalArgumentException("source == null");
        }
        return mo220write(bArr, 0, bArr.length);
    }

    @Override // okio.BufferedSink
    /* renamed from: write */
    public Buffer mo220write(byte[] bArr, int i, int i2) {
        if (bArr == null) {
            throw new IllegalArgumentException("source == null");
        }
        long j = i2;
    ...
    public Buffer mo221writeByte(int i) {
        Segment writableSegment = writableSegment(1);
        byte[] bArr = writableSegment.data;
    ...
    public Buffer mo228writeShort(int i) {
    ...
    public Buffer mo229writeShortLe(int i) {
        return mo228writeShort((int) Util.reverseBytesShort((short) i));
    }

    @Override // okio.BufferedSink
    /* renamed from: writeInt */
    public Buffer mo224writeInt(int i) {
    ...
    public Buffer mo225writeIntLe(int i) {
        return mo224writeInt(Util.reverseBytesInt(i));
    }

    @Override // okio.BufferedSink
    /* renamed from: writeLong */
    public Buffer mo226writeLong(long j) {
    ...
    public Buffer mo227writeLongLe(long j) {
        return mo226writeLong(Util.reverseBytesLong(j));
    }

    @Override // okio.BufferedSink
    /* renamed from: writeDecimalLong */
    public Buffer mo222writeDecimalLong(long j) {
        int i = (j > 0L ? 1 : (j == 0L ? 0 : -1));
        if (i == 0) {
            return mo221writeByte(48);
        }
        boolean z = false;
        int i2 = 1;
        if (i < 0) {
            j = -j;
            if (j < 0) {
                return mo232writeUtf8("-9223372036854775808");
            }
            z = true;
        }
        if (j >= 100000000) {
    ...
    public Buffer mo223writeHexadecimalUnsignedLong(long j) {
        if (j == 0) {
            return mo221writeByte(48);
        }
