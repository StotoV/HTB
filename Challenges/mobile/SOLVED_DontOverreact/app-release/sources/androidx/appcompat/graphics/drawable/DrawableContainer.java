    ...
    */
    ...
    public Drawable mutate() {
        if (!this.mMutated && super.mutate() == this) {
            DrawableContainerState mo6cloneConstantState = mo6cloneConstantState();
            mo6cloneConstantState.mutate();
            setConstantState(mo6cloneConstantState);
    ...
    DrawableContainerState mo6cloneConstantState() {
        return this.mDrawableContainerState;
    }
