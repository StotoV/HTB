...
public class CatalystInstanceImpl implements CatalystInstance {
    ...
    public native CallInvokerHolderImpl mo161getJSCallInvokerHolder();

    @Override // com.facebook.react.bridge.CatalystInstance
    /* renamed from: getNativeCallInvokerHolder */
    public native CallInvokerHolderImpl mo162getNativeCallInvokerHolder();
    ...
    public class AnonymousClass1 implements Runnable {
        ...
        public void run() {
            ...
            CatalystInstanceImpl.this.getReactQueueConfiguration().getJSQueueThread().runOnQueue(new RunnableC00051());
        }
