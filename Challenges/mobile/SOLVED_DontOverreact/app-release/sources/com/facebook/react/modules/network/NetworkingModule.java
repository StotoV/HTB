...
public final class NetworkingModule extends NativeNetworkingAndroidSpec {
    ...
    private MultipartBody.Builder constructMultipartBody(ReadableArray readableArray, String str, int i) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            Headers extractHeaders = extractHeaders(mo175getMap.getArray("headers"), null);
            if (extractHeaders == null) {
            ...
            if (mo175getMap.hasKey(REQUEST_BODY_KEY_STRING)) {
                builder.addPart(extractHeaders, RequestBody.create(mediaType, mo175getMap.getString(REQUEST_BODY_KEY_STRING)));
            } else if (!mo175getMap.hasKey(REQUEST_BODY_KEY_URI)) {
                ...
                String string = mo175getMap.getString(REQUEST_BODY_KEY_URI);
    ...
    private Headers extractHeaders(ReadableArray readableArray, ReadableMap readableMap) {
        ...
        for (int i = 0; i < size; i++) {
            ReadableArray mo174getArray = readableArray.mo174getArray(i);
            if (mo174getArray != null && mo174getArray.size() == 2) {
                String stripHeaderName = HeaderUtil.stripHeaderName(mo174getArray.getString(0));
                String stripHeaderValue = HeaderUtil.stripHeaderValue(mo174getArray.getString(1));
