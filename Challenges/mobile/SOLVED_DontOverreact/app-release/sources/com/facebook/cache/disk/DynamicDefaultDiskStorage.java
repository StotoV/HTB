...
public class DynamicDefaultDiskStorage implements DiskStorage {
    ...
    public Collection<DiskStorage.Entry> mo91getEntries() throws IOException {
        return get().mo91getEntries();
    }
    ...
    private void createStorage() throws IOException {
        File file = new File(this.mBaseDirectoryPathSupplier.mo126get(), this.mBaseDirectoryName);
