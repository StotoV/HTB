...
public abstract class LocalFetchProducer implements Producer<EncodedImage> {
    ...
    public EncodedImage getByteBufferBackedEncodedImage(InputStream inputStream, int i) throws IOException {
        ...
        try {
            if (i <= 0) {
                of = CloseableReference.of(this.mPooledByteBufferFactory.mo140newByteBuffer(inputStream));
            } else {
                of = CloseableReference.of(this.mPooledByteBufferFactory.mo141newByteBuffer(inputStream, i));
            }
            closeableReference = of;
