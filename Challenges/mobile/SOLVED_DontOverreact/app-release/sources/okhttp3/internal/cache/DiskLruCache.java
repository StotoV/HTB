...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    synchronized void rebuildJournal() throws IOException {
        ...
        buffer.mo232writeUtf8(MAGIC).mo221writeByte(10);
        buffer.mo232writeUtf8(VERSION_1).mo221writeByte(10);
        buffer.mo222writeDecimalLong(this.appVersion).mo221writeByte(10);
        buffer.mo222writeDecimalLong(this.valueCount).mo221writeByte(10);
        buffer.mo221writeByte(10);
        for (Entry entry : this.lruEntries.values()) {
            if (entry.currentEditor != null) {
                buffer.mo232writeUtf8(DIRTY).mo221writeByte(32);
                buffer.mo232writeUtf8(entry.key);
                buffer.mo221writeByte(10);
            } else {
                buffer.mo232writeUtf8(CLEAN).mo221writeByte(32);
                buffer.mo232writeUtf8(entry.key);
    ...
    public synchronized Snapshot get(String str) throws IOException {
        ...
        if (entry != null && entry.readable) {
            ...
            this.journalWriter.mo232writeUtf8(READ).mo221writeByte(32).mo232writeUtf8(str).mo221writeByte(10);
    ...
    synchronized Editor edit(String str, long j) throws IOException {
        ...
        if (j == ANY_SEQUENCE_NUMBER || (entry != null && entry.sequenceNumber == j)) {
            ...
            if (!this.mostRecentTrimFailed && !this.mostRecentRebuildFailed) {
                this.journalWriter.mo232writeUtf8(DIRTY).mo221writeByte(32).mo232writeUtf8(str).mo221writeByte(10);
    ...
    synchronized void completeEdit(Editor editor, boolean z) throws IOException {
        ...
        if (entry.readable | z) {
            entry.readable = true;
            this.journalWriter.mo232writeUtf8(CLEAN).mo221writeByte(32);
            this.journalWriter.mo232writeUtf8(entry.key);
            entry.writeLengths(this.journalWriter);
            this.journalWriter.mo221writeByte(10);
            if (z) {
            ...
            this.journalWriter.mo232writeUtf8(REMOVE).mo221writeByte(32);
            this.journalWriter.mo232writeUtf8(entry.key);
            this.journalWriter.mo221writeByte(10);
        }
        this.journalWriter.flush();
    ...
    boolean removeEntry(Entry entry) throws IOException {
        ...
        this.redundantOpCount++;
        this.journalWriter.mo232writeUtf8(REMOVE).mo221writeByte(32).mo232writeUtf8(entry.key).mo221writeByte(10);
        this.lruEntries.remove(entry.key);
        if (journalRebuildRequired()) {
            this.executor.execute(this.cleanupRunnable);
        }
    ...
    public final class Entry {
        ...
        void writeLengths(BufferedSink bufferedSink) throws IOException {
            for (long j : this.lengths) {
                bufferedSink.mo221writeByte(32).mo222writeDecimalLong(j);
            }
        }
