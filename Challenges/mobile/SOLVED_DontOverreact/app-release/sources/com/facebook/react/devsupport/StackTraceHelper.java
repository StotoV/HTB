    ...
    public static StackFrame[] convertJsStackTrace(ReadableArray readableArray) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (type == ReadableType.Map) {
                ...
                String string = mo175getMap.getString("methodName");
                stackFrameArr[i] = new StackFrameImpl(mo175getMap.getString(UriUtil.LOCAL_FILE_SCHEME), string, (!mo175getMap.hasKey(LINE_NUMBER_KEY) || mo175getMap.isNull(LINE_NUMBER_KEY)) ? -1 : mo175getMap.getInt(LINE_NUMBER_KEY), (!mo175getMap.hasKey(COLUMN_KEY) || mo175getMap.isNull(COLUMN_KEY)) ? -1 : mo175getMap.getInt(COLUMN_KEY), mo175getMap.hasKey("collapse") && !mo175getMap.isNull("collapse") && mo175getMap.getBoolean("collapse"));
