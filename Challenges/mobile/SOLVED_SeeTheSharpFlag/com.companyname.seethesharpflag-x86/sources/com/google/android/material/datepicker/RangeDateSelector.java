...
public class RangeDateSelector implements DateSelector<Pair<Long, Long>> {
    public static final Parcelable.Creator<RangeDateSelector> CREATOR = new Parcelable.Creator<RangeDateSelector>() { // from class: com.google.android.material.datepicker.RangeDateSelector.3
        ...
        public RangeDateSelector mo192createFromParcel(Parcel parcel) {
        ...
        public RangeDateSelector[] mo193newArray(int i) {
    ...
    public Pair<Long, Long> mo194getSelection() {
    ...
    public void updateIfValidTextProposal(TextInputLayout textInputLayout, TextInputLayout textInputLayout2, OnSelectionChangedListener<Pair<Long, Long>> onSelectionChangedListener) {
        ...
        if (l == null || this.proposedTextEnd == null) {
            ...
            onSelectionChangedListener.onSelectionChanged(mo194getSelection());
        } else {
