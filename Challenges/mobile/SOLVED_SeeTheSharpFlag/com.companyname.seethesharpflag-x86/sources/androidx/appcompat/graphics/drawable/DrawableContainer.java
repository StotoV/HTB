    ...
    */
    ...
    public Drawable mutate() {
        if (!this.mMutated && super.mutate() == this) {
            DrawableContainerState mo26cloneConstantState = mo26cloneConstantState();
            mo26cloneConstantState.mutate();
            setConstantState(mo26cloneConstantState);
    ...
    DrawableContainerState mo26cloneConstantState() {
        return this.mDrawableContainerState;
    }
