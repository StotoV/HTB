...
public class JavaOnlyArray implements ReadableArray, WritableArray {
        ...
        for (int i = 0; i < size; i++) {
            switch (AnonymousClass1.$SwitchMap$com$facebook$react$bridge$ReadableType[readableArray.getType(i).ordinal()]) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    javaOnlyArray.pushMap(JavaOnlyMap.deepClone(readableArray.mo175getMap(i)));
                    break;
                case 6:
                    javaOnlyArray.pushArray(deepClone(readableArray.mo174getArray(i)));
                    break;
            }
        }
    ...
    public ReadableArray mo174getArray(int i) {
    ...
    @Override // com.facebook.react.bridge.ReadableArray
    /* renamed from: getMap */
    public ReadableMap mo175getMap(int i) {
