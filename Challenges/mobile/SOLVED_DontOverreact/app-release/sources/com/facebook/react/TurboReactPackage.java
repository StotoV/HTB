...
public abstract class TurboReactPackage implements ReactPackage {
                    ...
                    */
                    private void findNext() {
                        ...
                        L28:
                            ...
                            return
                        */
                        throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.TurboReactPackage.AnonymousClass1.C00041.findNext():void");
                    }
    ...
    public List<ViewManager> createViewManagers(ReactApplicationContext reactApplicationContext) {
        ...
        for (ModuleSpec moduleSpec : viewManagers) {
            arrayList.add((ViewManager) moduleSpec.getProvider().mo160get());
        }
        return arrayList;
    }
