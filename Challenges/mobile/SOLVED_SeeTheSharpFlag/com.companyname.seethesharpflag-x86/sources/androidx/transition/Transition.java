...
public abstract class Transition implements Cloneable {
    ...
    public Transition(Context context, AttributeSet attributeSet) {
        ...
        if (namedInt >= 0) {
            mo134setDuration(namedInt);
        }
        long namedInt2 = TypedArrayUtils.getNamedInt(obtainStyledAttributes, xmlResourceParser, "startDelay", 2, -1);
        if (namedInt2 > 0) {
            mo137setStartDelay(namedInt2);
        }
        int namedResourceId = TypedArrayUtils.getNamedResourceId(obtainStyledAttributes, xmlResourceParser, "interpolator", 0, 0);
        if (namedResourceId > 0) {
            mo135setInterpolator(AnimationUtils.loadInterpolator(context, namedResourceId));
        }
    ...
    public Transition mo134setDuration(long j) {
        this.mDuration = j;
        return this;
    }
    ...
    public Transition mo137setStartDelay(long j) {
        this.mStartDelay = j;
        return this;
    }
    ...
    public Transition mo135setInterpolator(TimeInterpolator timeInterpolator) {
    ...
    public Transition mo125addTarget(View view) {
        this.mTargets.add(view);
        return this;
    }

    /* renamed from: addTarget */
    public Transition mo124addTarget(int i) {
        if (i != 0) {
    ...
    /* renamed from: addTarget */
    public Transition mo127addTarget(String str) {
    ...
    /* renamed from: addTarget */
    public Transition mo126addTarget(Class<?> cls) {
        if (this.mTargetTypes == null) {
    ...
    public Transition mo131removeTarget(View view) {
        this.mTargets.remove(view);
        return this;
    }

    /* renamed from: removeTarget */
    public Transition mo130removeTarget(int i) {
        if (i != 0) {
    ...
    /* renamed from: removeTarget */
    public Transition mo133removeTarget(String str) {
    ...
    /* renamed from: removeTarget */
    public Transition mo132removeTarget(Class<?> cls) {
    ...
    public Transition mo123addListener(TransitionListener transitionListener) {
    ...
    public Transition mo129removeListener(TransitionListener transitionListener) {
        ArrayList<TransitionListener> arrayList = this.mListeners;
        if (arrayList == null) {
            return this;
        }
    ...
    public Transition mo136setSceneRoot(ViewGroup viewGroup) {
