...
public abstract class ViewManager<T extends View, C extends ReactShadowNode> extends BaseJavaModule {
    ...
    protected abstract T mo207createViewInstance(ThemedReactContext themedReactContext);
    ...
    public C mo204createShadowNodeInstance() {
        throw new RuntimeException("ViewManager subclasses must implement createShadowNodeInstance()");
    }

    public C createShadowNodeInstance(ReactApplicationContext reactApplicationContext) {
        return mo204createShadowNodeInstance();
    }

    protected T createViewInstance(ThemedReactContext themedReactContext, ReactStylesDiffMap reactStylesDiffMap, StateWrapper stateWrapper) {
        Object updateState;
        T mo207createViewInstance = mo207createViewInstance(themedReactContext);
        addEventEmitters(themedReactContext, mo207createViewInstance);
        if (reactStylesDiffMap != null) {
            updateProperties(mo207createViewInstance, reactStylesDiffMap);
        }
        if (stateWrapper != null && (updateState = updateState(mo207createViewInstance, reactStylesDiffMap, stateWrapper)) != null) {
            updateExtraData(mo207createViewInstance, updateState);
        }
        return mo207createViewInstance;
    }
