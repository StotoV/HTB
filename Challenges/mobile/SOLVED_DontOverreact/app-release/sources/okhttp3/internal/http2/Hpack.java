...
public final class Hpack {
    ...
    static final class Writer {
        ...
        void writeInt(int i, int i2, int i3) {
            if (i < i2) {
                this.out.mo221writeByte(i | i3);
                return;
            }
            this.out.mo221writeByte(i3 | i2);
            int i4 = i - i2;
            while (i4 >= 128) {
                this.out.mo221writeByte(128 | (i4 & Hpack.PREFIX_7_BITS));
                i4 >>>= 7;
            }
            this.out.mo221writeByte(i4);
        }
        ...
        void writeByteString(ByteString byteString) throws IOException {
            if (this.useCompression && Huffman.get().encodedLength(byteString) < byteString.size()) {
                ...
                this.out.mo218write(readByteString);
                return;
            }
            writeInt(byteString.size(), Hpack.PREFIX_7_BITS, 0);
            this.out.mo218write(byteString);
        }
