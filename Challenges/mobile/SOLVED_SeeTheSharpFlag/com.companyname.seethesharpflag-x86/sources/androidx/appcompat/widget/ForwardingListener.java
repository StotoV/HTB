...
public abstract class ForwardingListener implements View.OnTouchListener, View.OnAttachStateChangeListener {
    ...
    public abstract ShowableListMenu mo49getPopup();
    ...
    protected boolean onForwardingStarted() {
        ShowableListMenu mo49getPopup = mo49getPopup();
        if (mo49getPopup == null || mo49getPopup.isShowing()) {
            return true;
        }
        mo49getPopup.show();
        return true;
    ...
    */
    ...
    private boolean onTouchForwarded(MotionEvent motionEvent) {
        ...
        View view = this.mSrc;
        ShowableListMenu mo49getPopup = mo49getPopup();
        if (mo49getPopup == null || !mo49getPopup.isShowing() || (dropDownListView = (DropDownListView) mo49getPopup.getListView()) == null || !dropDownListView.isShown()) {
            return false;
        }
