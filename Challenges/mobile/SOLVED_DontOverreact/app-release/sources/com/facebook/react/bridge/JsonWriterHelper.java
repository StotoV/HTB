            ...
            while (keySetIterator.hasNextKey()) {
                ...
                switch (AnonymousClass1.$SwitchMap$com$facebook$react$bridge$ReadableType[readableMap.getType(nextKey).ordinal()]) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        readableMapValue(jsonWriter, readableMap.mo176getMap(nextKey));
                        break;
                    case 6:
            ...
            try {
                switch (AnonymousClass1.$SwitchMap$com$facebook$react$bridge$ReadableType[readableArray.getType(i).ordinal()]) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        readableMapValue(jsonWriter, readableArray.mo175getMap(i));
                        break;
                    case 6:
                        readableArrayValue(jsonWriter, readableArray.mo174getArray(i));
                        break;
                    default:
