...
public class SwipeRefreshLayoutManager extends ViewGroupManager<ReactSwipeRefreshLayout> implements AndroidSwipeRefreshLayoutManagerInterface<ReactSwipeRefreshLayout> {
    ...
    public ReactSwipeRefreshLayout mo207createViewInstance(ThemedReactContext themedReactContext) {
        ...
        if (readableArray != null) {
            ...
            for (int i = 0; i < readableArray.size(); i++) {
                if (readableArray.getType(i) == ReadableType.Map) {
                    iArr[i] = ColorPropConverter.getColor(readableArray.mo175getMap(i), reactSwipeRefreshLayout.getContext()).intValue();
                } else {
